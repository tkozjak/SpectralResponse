    ...
    Buffer{
        ...
        data: {
            ...
            for(var i = 0; i < buffer.length; i+=3){
                buffer[i+2] = parseFloat(longResponses[i/3]) / ( parseFloat(longResponses[i/3]) + parseFloat(shortResponses[i/3]) + parseFloat(mediumResponses[i/3]) );
                buffer[i+1] = parseFloat(shortResponses[i/3]) / ( parseFloat(longResponses[i/3]) + parseFloat(shortResponses[i/3]) + parseFloat(mediumResponses[i/3]) );
                buffer[i+0] = parseFloat(mediumResponses[i/3]) / ( parseFloat(longResponses[i/3]) + parseFloat(shortResponses[i/3]) + parseFloat(mediumResponses[i/3]) );
            }
